...
| `maxTokens` | unbounded | Î£ tokens across the whole hop chain. Hard ceiling 1B. |
| `maxUsd` | unbounded | Î£ USD across hops. Hard ceiling $1M. |
